...
public class MainPageTN extends BasePage {
    private static Logger logger = LogManager.getLogger(MainPageTN.class);
    ...
    private WebElement getDeleteButton(){
        By deletePlaylistBy = By.xpath("//*[@class=\"del btn-delete-playlist\"]");
        return driver.findElement(deletePlaylistBy) ;
    }
