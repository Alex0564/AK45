...
public class App1 {
    public static void main(String[] args) {
        ...
        truck2.brand = Brand.TOYOTA;
        truck2.fuelType = toyotaFuel;
        truck2.setLoadCapacity(12000);
        ...
        Car car2 = new Car();
        car2.brand = Brand.BMW;
        car2.fuelType = bmwFuel;
        car2.setPassengerSeats(3);
        ...
        moto2.brand = Brand.SUZUKI;
        moto2.fuelType = suzukiMotoFuel;
        moto2.setNumberOfWheels(2);
